...
$FechaN=$fec_nac;
$AñoAcademico=$grado; $Seccion=$seccion; $PeriodoEscolar=date("Y");
...
$Nombre=strtoupper($Nombre);
 ...
 $sql="Select * from representantes INNER JOIN personas ON personas.id=representantes.persona_id WHERE persona_id=$representante_id";
 $ejc=mysqli_query($conexion,$sql);
 while ($representante=mysqli_fetch_array($ejc)) { extract($representante); }
 $Nom_representante="$pri_nom $seg_nom $pri_ape $seg_ape";
...
$Nom_director="$pri_nom $seg_nom $pri_ape $seg_ape"; $CI_director=$ci; $Cargo=$dsc;
...
$titulo="<br><br><h2 align='center'><B>CONSTANCIA DE ASISTENCIA</B></h2>";

$texto="<p align=justify style='text-indent: 1cm'> Quien suscribe, Prof. <b>$Nom_director</b>, titular de la Cédula de Identidad: <b>V-$CI_director</b> Director (E) de la casa de estudios, ubicada en la Parroquia Santa Cruz, Municipio Maturín, Estado Monagas. Hace constar que el (la) Sr. (a) <b>$Nom_representante</b> representante del alumno(a): <b>$Nombre</b>, quien cursa <b>$AñoAcademico</b> Año, sección:<b> $Seccion</b>. <br><br>Asistió el día de hoy $DiaActual  de  $MesActual del $AñoActual; a ____________________________________ de su representado.<p align=justify style='text-indent: 1cm'> Constancia que se expide a solicitud de la parte interesada a los $DiaActual días del mes de $MesActual del año $AñoActual.</p><br><br><br><br>";	

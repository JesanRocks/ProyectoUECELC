...
$titulo="<br><br><h2 align='center'><B>CONSTANCIA DE BUENA CONDUCTA</B><h2>";
$texto="
<p align=justify style='text-indent: 1cm'> Quien suscribe el Director (E) Prof. <b>$Nom_director</b>, titular de la cédula de Identidad: <b>V-$CI_director</b>, la Unidad Educativa Complejo Educativo “Las Carolinas”, ubicado en la calle principal de Las Carolinas, Municipio Maturín, Estado Monagas, hace constar que el alumno(a) <b>$Nombre</b> de  <b>$Edad</b> años de edad, Natural de <b>$direccion</b>, Fecha de Nacimiento <b>$FechaN</b>, curso el  <b>$AñoAcademico</b> año de Educación <b>$NivelDeEstudio</b>, observando una buena conducta.</p>  

<p align=justify style='text-indent: 1cm'>Constancia que se expide a solicitud de la parte interesada a los $DiaActual días del mes de $MesActual del año $AñoActual.</p><br><br>";	

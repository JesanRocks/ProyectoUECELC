    ...
    <form class="form" action="" method="POST">
      <div class="form-row">
        ...
        <div class='form-group col-md-4'> 
          ...
          <label><input type=radio name="padre" value="Si" checked> Si </label>
              
          <label><input type=radio name="padre" value="No" disabled> No </label>
        </div>
        
        <div class='form-group col-md-4'> 
          <label for=genero>¿Es la madre?</label><br>                
          <label><input type=radio name="madre" value="Si" disabled> Si </label>
              
          <label><input type=radio name="madre" value="No" checked> No </label>
        </div>
...
$SQL="INSERT INTO `representantes`(`edocivil_id`, `lug_nac`, `profesion`, `empresa`, `lug_trab`, `telf_emp`, `telf_cel`, `telf_hab`, `correo`, `parentesco_id`, `legal`, `persona_id`,`dependencia_id`) VALUES ('$edoc','$lugN','$puo','$emp','$ldt','$n_emp','$n_cel','$n_hab','$correo','$parentesco','$legal','$id','$dependencia')";
 $Ejec=mysqli_query($conexion,$SQL);
  ...
  if ($padre=="Si" && $madre=="No" && $legal=="No") {
   echo "<br> <a class='btn btn-info btn-block' href='estudiante.php'>Registrar datos del estudiante</a>"; 
  }
